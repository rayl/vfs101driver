...
int S2_checked (struct vfs_dev *dev)
{
	...
	__(  409,    SetParam (dev, P_INFO_LINE_RATE, info_line_rate));
	...
	__(  433,    SetParam (dev, P_INFO_LINE_RATE, info_line_rate));
	...
	__(  447,    SetParam (dev, P_INFO_LINE_RATE, info_line_rate));
