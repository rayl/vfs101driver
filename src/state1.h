int S1_unchecked (struct vfs_dev *dev)
{
	...
	_(  SetParam (dev, P_MESS_WITH_BC, mess_with_bc));
	...
	_(  SetParam (dev, P_THRESHOLD, 0x0096));
	...
	_(  SetParam (dev, P_STATE_3_COUNT, 0x0064));
	_(  SetParam (dev, P_STATE_5_COUNT, 0x00c8));
	_(  SetParam (dev, 0x0060, 0x00c8));
	_(  SetParam (dev, P_INFO_LINE_RATE, 0x0000));
	...
	_(  Peek (dev, VFS_GRATING, 0x01));
	_(  Poke (dev, VFS_GRATING, 0x00000010, 0x01));
	_(  Peek (dev, VFS_KILL_4, 0x01));
	_(  Peek (dev, 0x00ff9800, 0x01));
	_(  Peek (dev, 0x00ff9806, 0x01));
	_(  GetPrint (dev, 0x0064, type_0));
...
int S1_checked (struct vfs_dev *dev)
{
	...
	__(   55,    SetParam (dev, P_MESS_WITH_BC, mess_with_bc));
	...
	__(  149,    SetParam (dev, P_THRESHOLD, 0x0096));
	...
	__(  161,    SetParam (dev, P_STATE_3_COUNT, 0x0064));
	__(  163,    SetParam (dev, P_STATE_5_COUNT, 0x00c8));
	__(  165,    SetParam (dev, 0x0060, 0x00c8));
	__(  167,    SetParam (dev, P_INFO_LINE_RATE, 0x0000));
	...
	__(  206,    Peek (dev, VFS_DARKEN_CD_1, 0x02));
	__(  208,    Peek (dev, VFS_DARKEN_CD_2, 0x02));
	__(  210,    Poke (dev, 0x000005f6, 0x00000001, 0x01));
	__(  212,    Peek (dev, VFS_GRATING, 0x01));
	__(  214,    Poke (dev, VFS_GRATING, 0x00000000, 0x01));
	__(  216,    Peek (dev, VFS_KILL_4, 0x01));
	...
	__(  229,    Peek (dev, VFS_GRATING, 0x01));
	__(  231,    Poke (dev, VFS_GRATING, 0x00000010, 0x01));
	__(  233,    Peek (dev, VFS_KILL_4, 0x01));
	__(  235,    Peek (dev, 0x00ff9800, 0x01));
	__(  237,    Peek (dev, 0x00ff9806, 0x01));
	__(  239,    GetPrint (dev, 0x0064, type_0));
	 _(          LoadImage (dev));
	__(  242,    Peek (dev, VFS_CONTRAST, 0x01));
	__(  244,    Peek (dev, VFS_EXPOSURE, 0x02));
	__(  246,    Peek (dev, VFS_IMAGE_ABCD, 0x01));
	__(  248,    Poke (dev, VFS_IMAGE_ABCD, 0x00000012, 0x01));
	__(  250,    Poke (dev, VFS_EXPOSURE, 0x00004000, 0x02));
	__(  252,    Poke (dev, VFS_CONTRAST, 0x0000000f, 0x01));
	__(  254,    SetParam (dev, P_INFO_LINE_RATE, 0x0000));
	__(  256,    SetParam (dev, P_INFO_CONTRAST, 0x0000));
	...
	__(  267,    Peek (dev, VFS_GRATING, 0x01));
	__(  269,    Poke (dev, VFS_GRATING, 0x00000000, 0x01));
	__(  271,    Peek (dev, VFS_KILL_4, 0x01));
	__(  273,    Peek (dev, 0x00ff9800, 0x01));
	__(  275,    Peek (dev, 0x00ff9806, 0x01));
	 _(          scan_contrast (dev));
	__(  307,    Poke (dev, 0x000005f6, 0x00000000, 0x01));
	__(  309,    Peek (dev, VFS_GRATING, 0x01));
	__(  311,    Poke (dev, VFS_GRATING, 0x00000010, 0x01));
	__(  313,    Peek (dev, VFS_KILL_4, 0x01));
	...
	__(  321,    GetPrint (dev, 0x000a, type_0));
	 _(          LoadImage (dev));
	__(  324,    SetParam (dev, P_INFO_CONTRAST, best_contrast));
	__(  326,    SetParam (dev, 0x0076, 0x0012));
	__(  328,    SetParam (dev, 0x0078, 0x2230));
	__(  330,    Poke (dev, VFS_CONTRAST, 0x00000014, 0x01));
	__(  332,    Poke (dev, VFS_EXPOSURE, exposure, 0x02));
	__(  334,    Poke (dev, VFS_IMAGE_ABCD, 0x00000031, 0x01));
	__(  336,    SetParam (dev, P_INFO_LINE_RATE, info_line_rate));
	__(  338,    AbortPrint (dev));
	 _(          LoadImage (dev));
	__(  341,    SetParam (dev, P_INFO_LINE_RATE, info_line_rate));
	__(  343,    GetVersion (dev));
	__(  345,    SetParam (dev, 0x0055, 0x0008));
	__(  347,    GetParam (dev, 0x0014));
	__(  349,    GetParam (dev, 0x0011));
	__(  351,    SetParam (dev, P_INFO_LINE_RATE, info_line_rate));
	...
	__(  365,    SetParam (dev, P_INFO_LINE_RATE, info_line_rate));
