...
int PREFIX_checked (struct vfs_dev *dev)
{
	...
	__( 4915,    LoadImage (dev));
	__( 4918,    GetPrint (dev, 0x0001, type_0));
	__( 4918,    LoadImage (dev));
	__( 4921,    AbortPrint (dev));
	__( 4921,    LoadImage (dev));
